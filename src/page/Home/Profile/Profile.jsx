...
const Profile = () => {
    return (
        <>
            <div className="flex justify-center items-center flex-col md:flex-row space-y-5 md:space-x-16 font-semibold">
                ...
                <div>
                    ...
                    <div className="flex justify-start items-center flex-col md:flex-row gap-1 md:my-2">
                        <span className=" text-3xl font-bold text-[#64748B] dark:text-[#9F9F9F]">Software Developer.</span>
                    ...
                    <div className="flex justify-between items-center gap-3 md:gap-6 flex-col md:flex-row mt-5 md:mt-7 tex-sm md:text-xs text-[#0D1117] dark:text-[#9F9F9F]">
                        {/* Location */}
