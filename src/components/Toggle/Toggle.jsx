    ...
    return (
        <>
            {darkMode ? (
                ...
                <button
                    onClick={toggleTheme}
                    className="border rounded-full border-[#f43f5e] rotate-0 group-hover:rotate-180 duration-300 transition-transform"
                >
                    <svg
                        width="22"
                        height="22"
